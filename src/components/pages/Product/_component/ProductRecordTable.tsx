...
export default function ProductRecordTable({
  ...
  <thead className="bg-gray-50 sticky top-0 z-20">
    <tr>
      ...
      <th className="px-4 py-3 w-36">Images</th>
      <th className="px-4 py-3 max-w-[200px]">Product</th>
      <th className="px-4 py-3 max-w-[200px]">Category</th>
      <th className="px-4 py-3 w-28">Status</th>
      <th className="px-4 py-3 w-28">Reason</th>
      <th className="px-4 py-3 w-32">Link</th>
    </tr>
  </thead>
