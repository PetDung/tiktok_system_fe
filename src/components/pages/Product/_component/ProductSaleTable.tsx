      ...
      <table className="min-w-full text-sm">
        <thead className="bg-gray-50 sticky top-0 z-20">
          <tr>
            ...
            <th className="px-4 py-3 text-left font-bold text-gray-700">Sold</th>
            ...
            return (
              <Fragment key={product.productId}>
                ...
                >
                  ...
                  <td className="px-4 py-3 text-gray-600">{product.productId}</td>
                  ...
                  <td className="px-4 py-3 text-gray-600 max-w-xs font-bold">
